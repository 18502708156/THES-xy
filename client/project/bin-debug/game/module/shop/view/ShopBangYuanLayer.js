...
var ShopBangYuanLayer = (function (_super) {
    __extends(ShopBangYuanLayer, _super);
    /////////////////////////////////////////////////////////////////////////////
    function ShopBangYuanLayer() {
    ...
    ShopBangYuanLayer.prototype.OnOpen = function () {
    ...
    ShopBangYuanLayer.prototype.setData = function () {
        this.tShopData = ShopController.ins().getShopDataByIndex(ShopController.EN_SHOP_BANGYUAN);
    };
    ShopBangYuanLayer.prototype.UpdateContent = function () {
        this.setData();
    ...
    ShopBangYuanLayer.prototype.onListViewClick = function (e) {
        var pItem = e.item;
        if (pItem && ShopController.ins().enoughBuy(pItem)) {
            ViewManager.ins().open(BuyWin, pItem);
        }
    };
    ShopBangYuanLayer.prototype.setMoney = function () {
        this.setData();
    ...
    ShopBangYuanLayer.NAME = "绑元商店";
    return ShopBangYuanLayer;
}(BaseView));
__reflect(ShopBangYuanLayer.prototype, "ShopBangYuanLayer", ["ICommonWindowTitle"]);
//# sourceMappingURL=ShopBangYuanLayer.js.map