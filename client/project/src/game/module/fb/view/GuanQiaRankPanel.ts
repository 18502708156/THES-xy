class GuanQiaRankPanel extends BaseEuiView {
    ...
    UpdateContent() {
        let rankData = GameGlobal.RankingModel.ranks[RankingModel.RANK_TYPE_FB]
...
class GuanQiaRankItem extends eui.ItemRenderer {
