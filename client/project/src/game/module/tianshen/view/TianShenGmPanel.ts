class TianShenGmPanel extends BaseEuiView {
	...
	public constructor() {
		super()
		this.skinName = "TianShenGmSkin"
		this._AddClick(this, this.CloseSelf)
	}

	public OnOpen() {
		let model = GameGlobal.TianShenBaoQiModel
		let allLevel = model.GetAllLevel()
		let config = GameGlobal.Config.AirMarshalResonateConfig
		let level = 0
		for (let i = 1; i < 99; i++) {
